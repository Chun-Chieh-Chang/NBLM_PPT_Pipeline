...
**Font Stack**: `"Microsoft YaHei", "微軟雅黑", "PingFang SC", Arial, sans-serif`
...
|------|-------------------|-------|
| `重慶大學logo.png` | Light/white backgrounds | Blue version |
| `重慶大學logo2.png` | Dark/blue backgrounds | White version |
